 ...
 *
 */
public class DeltaHantoPlayerState implements PlayerState {

	private final int MAX_NUMBER_BUTTERFLIES = 1;
	private final int MAX_NUMBER_SPARROWS = 4;
	private final int MAX_NUMBER_CRABS = 4;
	...
	public PlayerState checkPieceCountValidity(HantoPieceType pieceType) throws HantoException {
		...
		{
			oppositePlayerState = new DeltaHantoPlayerState();
		}
